...
import 'package:row_and_column/misc/layout_type.dart';
import 'package:row_and_column/misc/row_column_layout_attributes.dart';
import 'package:row_and_column/widgets/main_app_bar.dart';

class RowColumnTesterScreen extends StatefulWidget implements HasLayoutGroup {
  ...
  @override
  _RowColumnTesterScreenState createState() => _RowColumnTesterScreenState();
}

class _RowColumnTesterScreenState extends State<RowColumnTesterScreen> {
  bool _isRow = true;
